...
// 마커 데이터 (위치 및 가격 정보)
var positions = [
    { latlng: new kakao.maps.LatLng(37.574828, 126.926584), price: "3억" },
    { latlng: new kakao.maps.LatLng(37.576242, 126.929076), price: "2억 5천만 원" },
    { latlng: new kakao.maps.LatLng(37.572192, 126.929267), price: "3,000만 원" }
];
